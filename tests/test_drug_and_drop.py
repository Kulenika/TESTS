...
def test_drug_and_drop(browser):
    ...
    assert droppable.drop.check_css_new('backgroundColor', 'rgba(0, 0, 0, 0)')
    ...
    assert droppable.drop.check_css_new('backgroundColor', 'rgba(70, 130, 180, 1)')
    action_chains.drug_and_drop_by_offset(
